...
print(f"Selected Features: {selected_features} Total features: ({len(selected_features)})")
end_time = time.time()

training_time = end_time - start_time
print(f"Training Time: {training_time} seconds or {training_time/60} minutes")
